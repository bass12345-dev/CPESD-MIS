    ...
    <table class="table table-hover table-striped table-information " id="table-information" style="width: 100%; ">
        ...
        <tr>
            ...
            <td class="text-start">
                ...
                <select class="form-control" name="province" hidden>
        ...
        <tr>
            ...
            <td class="text-start">
                ...
                <select class="form-control" name="barangay" hidden>
        ...
        <tr>
            ...
            <td class="text-start">
                ...
                <input type="hidden" class="form-control " name="telephone_number" value="{{$row->email_address}}">
            </td>
        </tr>
        <tr>
            <td>Proprietor</td>
        ...
        <tr>
            <td>Status</td>
            <td class="text-start">
                <span class="title1">{{$row->status}}</span>
